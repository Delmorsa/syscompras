		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
					...
					<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
						...
						<div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
							...
							<a href="" class="py-9 pt-lg-20">
								<img alt="Logo" src="<?php echo base_url()?>/assets/img/LOGO.png" class="h-100px" />
							</a>
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="fw-bolder text-white fs-2qx pb-5 pb-md-10">Bienvenidos a <?php echo basename(FCPATH)?></h1>
							<!--end::Title-->
							<!--begin::Description-->
							<p class="fw-bold fs-2 text-white">Realiza y administra solicitudes de compras para cada área de la empresa.</p>
							<!--end::Description-->
						</div>
						<!--end::Header-->
						<!--begin::Illustration-->
				...
				<div class="d-flex flex-column flex-lg-row-fluid py-10">
					<!--begin::Content-->
					<div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-450px" 
                        style="background-image: url(<?php echo base_url()?>/assets/SYSCOMPRAS.png);"></div>
					...
					<div class="d-flex flex-center flex-wrap fs-6 p-5 pb-0">
						...
						<div class="d-flex flex-center fw-bold fs-6">
							<p class="text-center"><?php echo "INDUSTRIAS DELMOR S.A. </br>"."&copy;
