						...
						<div id="kt_content_container" class="container-fluid">
									...
									<div class="card card-flush h-md-50 mb-5 mb-xl-10">
										...
										<div class="card-header pt-5">
											...
											<div class="card-toolbar">
												<!--begin::Menu-->
												<button class="btn btn-icon btn-color-gray-400 btn-active-color-primary mt-n2 me-n2"
								...
								<div class="col-lg-12 col-xl-12 col-xxl-6 mb-5 mb-xl-0">
									...
									<div class="card card-flush overflow-hidden h-md-100">
										...
										<div class="card-header py-5">
											...
											<div class="card-toolbar">
												<!--begin::Menu-->
												<button class="btn btn-icon btn-color-gray-400 btn-active-color-primary mt-n2 me-n3"
													data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end"
													data-kt-menu-overflow="true">
													<!--begin::Svg Icon | path: icons/duotune/general/gen023.svg-->
													<span class="svg-icon svg-icon-1">
										...
										<div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
											...
											<div class="px-9 mb-5">
												...
												<div class="d-flex mb-2">
													...
													<span
														class="badge badge-success fs-6 p-2 d-flex align-items-center align-self-center">
														<!--begin::Svg Icon | path: icons/duotune/arrows/arr067.svg-->
							...
							<div class="row gy-5 g-xl-10">
								...
								<div class="col-xl-4 mb-xl-10">
									...
									<div class="card h-md-100">
										<!--begin::Body-->
										<div class="card-body d-flex flex-column py-17">
											<div class="mb-1">
												<!--begin::Item-->
												...
												<!--end::Item-->
												<!--begin::Image-->
												<div class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center card-rounded-bottom h-175px mh-175px my-5 my-lg-12"
													style="background-image:url('../assets/media/svg/illustrations/easy/2.svg')"></div>
												<!--end::Image-->
											</div>
											<!--begin::Links-->
											<div class="text-center">
												<a class="btn btn-sm btn-primary me-2" href="../apps/invoices/create.html">Try now</a>
										...
										<div class="card-body">
											...
											<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
												...
												<tbody class="fw-bolder text-gray-600">
													<tr data-kt-table-widget-4="subtable_template" class="bg-light- d-none">
														<td colspan="2">
															<div class="d-flex align-items-center gap-3">
																<a href="#"
																	class="symbol symbol-50px bg-secondary bg-opacity-25 rounded">
																	<img src="../assets/media/stock/ecommerce/index.html" alt=""
													...
													<tr>
														...
														<td class="text-end">7 January 2022, 9:05 pm</td>
														<td class="text-end">
													...
													<tr>
														...
														<td class="text-end">7 January 2022, 8:13 pm</td>
														<td class="text-end">
													...
													<tr>
														...
														<td class="text-end">7 January 2022, 5:05 pm</td>
														<td class="text-end">
													...
													<tr>
														...
														<td class="text-end">6 January 2022, 9:05 pm</td>
														<td class="text-end">
													...
													<tr>
														...
														<td class="text-end">5 January 2022, 9:05 pm</td>
														<td class="text-end">
													...
													<tr>
														...
														<td class="text-end">4 January 2022, 9:05 pm</td>
														<td class="text-end">
															<a href="#" class="text-dark text-hover-primary">Brian Cox</a>
														</td>
													...
													<tr>
														...
														<td class="text-end">1 January 2022, 9:05 pm</td>
														<td class="text-end">
							...
							<div class="row gy-5 g-xl-10">
								...
								<div class="col-xl-4">
									...
									<div class="card card-flush h-xl-100">
										...
										<!--end::Header-->
										<!--begin::Body-->
										<div class="card-body hover-scroll-overlay-y pt-0 pe-6 me-3 mb-9 pb-0" style="height: 415px">
											<!--begin::Item-->
											<div class="card px-7 pt-5 pb-7 border-dashed border-1 border-gray-300 mb-7">
												<!--begin::Section-->
												<div class="d-flex flex-stack mb-3">
													...
													<div class="m-0">
														<!--begin::Menu-->
														<button
															class="btn btn-icon btn-color-gray-400 btn-active-color-primary mt-n2 me-n3"
															data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end"
															data-kt-menu-overflow="true">
															<!--begin::Svg Icon | path: icons/duotune/general/gen023.svg-->
															<span class="svg-icon svg-icon-1">
												...
												<div class="d-flex flex-stack">
													...
													<span class="text-gray-400 fw-bolder">To:
														<span class="text-gray-800 fw-bolder">Jason Bourne</span></span>
													<!--end::Info-->
													<!--begin::Label-->
											...
											<div class="card px-7 pt-5 pb-7 border-dashed border-1 border-gray-300 mb-7">
												...
												<div class="d-flex flex-stack">
													<!--begin::Info-->
													<span class="text-gray-400 fw-bolder">To:
														<span class="text-gray-800 fw-bolder">Marie Durant</span></span>
													<!--end::Info-->
													<!--begin::Label-->
											...
											<div class="card px-7 pt-5 pb-7 border-dashed border-1 border-gray-300 mb-7">
												...
												<div class="d-flex flex-stack">
													<!--begin::Info-->
													<span class="text-gray-400 fw-bolder">To:
														<span class="text-gray-800 fw-bolder">Dan Wilson</span></span>
													<!--end::Info-->
													<!--begin::Label-->
											...
											<div class="card px-7 pt-5 pb-7 border-dashed border-1 border-gray-300 mb-7">
												...
												<div class="d-flex flex-stack">
													<!--begin::Info-->
													<span class="text-gray-400 fw-bolder">To:
														<span class="text-gray-800 fw-bolder">Lebron Wayde</span></span>
													<!--end::Info-->
													<!--begin::Label-->
													<span class="badge badge-light-success">Delivered</span>
													<!--end::Label-->
											...
											<div class="card px-7 pt-5 pb-7 border-dashed border-1 border-gray-300 mb-7">
												...
												<div class="d-flex flex-stack">
													<!--begin::Info-->
													<span class="text-gray-400 fw-bolder">To:
														<span class="text-gray-800 fw-bolder">Ana Simmons</span></span>
													<!--end::Info-->
													<!--begin::Label-->
													<span class="badge badge-light-primary">Shipping</span>
													<!--end::Label-->
											...
											<!--end::Item-->
											<!--begin::Item-->
											<div class="card px-7 pt-5 pb-7 border-dashed border-1 border-gray-300">
												<!--begin::Section-->
												<div class="d-flex flex-stack mb-3">
													<!--begin::Section-->
													<div class="me-3">
												...
												<div class="d-flex flex-stack">
													<!--begin::Info-->
													<span class="text-gray-400 fw-bolder">To:
														<span class="text-gray-800 fw-bolder">Kevin Leonard</span></span>
													<!--end::Info-->
													<!--begin::Label-->
													<span class="badge badge-light-danger">Confirmed</span>
													<!--end::Label-->
										...
										<div class="card-header pt-7">
											...
											<div class="card-toolbar">
												...
												<div class="d-flex flex-stack flex-wrap gap-4">
													...
													<!--end::Status-->
													<!--begin::Search-->
													<button class="btn btn-light btn-sm">View Stock</button>
													<!--end::Search-->
												</div>
												<!--begin::Filters-->
											</div>
											...
											<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
												...
												<tbody class="fw-bolder text-gray-600">
													...
													<tr>
														...
														<!--end::Product ID-->
														<!--begin::Date added-->
														<td class="text-end">Sep 22, 2022</td>
														<!--end::Date added-->
														<!--begin::Price-->
														<td class="text-end">$1,060</td>
														<!--end::Price-->
													...
													<tr>
														...
														<!--end::Product ID-->
														<!--begin::Date added-->
														<td class="text-end">Jun 24, 2022</td>
														<!--end::Date added-->
														<!--begin::Price-->
											...
											<div class="current" data-kt-stepper-element="content">
												...
												<div class="w-100">
													...
													<div class="pb-10 pb-lg-15">
														<!--begin::Title-->
														<h2 class="fw-bolder d-flex align-items-center text-dark">Setup Campaign
															Details
															<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
														...
														<div class="d-flex fv-row">
															...
															<div class="form-check form-check-custom form-check-solid">
																...
																<label class="form-check-label" for="kt_modal_update_role_option_1">
																	<div class="fw-bolder text-gray-800">Get more messages on chat
																	</div>
													...
													<div class="fv-row mb-10">
														...
														<div class="dropzone" id="kt_modal_create_project_files_upload">
															...
															<div class="dz-message needsclick">
																...
																<!--begin::Info-->
																<div class="ms-4">
																	<h3 class="dfs-3 fw-bolder text-gray-900 mb-1">Drop campaign files
														...
														<div class="row g-9" data-kt-buttons="true"
															...
															<div class="col">
																...
																<label
																	...
																	<span class="ms-5">
																		<span
																			class="fs-4 fw-bolder text-gray-800 d-block">Female</span>
																	</span>
																	<!--end::Info-->
																</label>
																<!--end::Option-->
