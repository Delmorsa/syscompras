									...
									<div class="card card-flush h-lg-100">
										...
										<div class="card-header pt-5">
											...
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark">Reporte historial de solicitudes</span>
											</h3>
											<!--end::Title-->
											<!--begin::Toolbar-->
								...
								<div class="col-xl-3 mb-xl-3">
									...
									<div class="card card-flush h-lg-100">
										...
										<div class="card-header pt-5">
											<!--begin::Title-->
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark">Prioridad Solicitudes</span>
											</h3>
											<!--end::Title-->
											<!--begin::Toolbar-->
											<div class="card-toolbar">
										...
										<!--end::Header-->
										<!--begin::Body-->
										<div class="card-body pt-0 px-0 chartreportPrio">
											<!--begin::Chart-->
											<canvas id="myChartPiePrio"></canvas>
											<!--end::Chart-->
								...
								<div class="col-xl-3 mb-xl-3">
									...
									<div class="card card-flush h-lg-100">
										...
										<div class="card-header pt-5">
											<!--begin::Title-->
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark">Estado de Solicitudes</span>
											</h3>
											<!--end::Title-->
											<!--begin::Toolbar-->
											<div class="card-toolbar">
										...
										<!--end::Header-->
										<!--begin::Body-->
										<div class="card-body pt-0 px-0 chartreportPie">
											<!--begin::Chart-->
									...
									<div class="card h-md-100">
										...
										<div class="card-body d-flex flex-column py-17">
											<div class="mb-1">
												...
												<span class="fw-boldest">Solicitudes por usuario</span></h1>
												<!--end::Item-->
												<!--begin::Image-->
