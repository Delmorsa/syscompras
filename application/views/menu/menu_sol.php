												...
												<div class="menu-item">
													...
													<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
														<span class="menu-link">
															...
															<span class="menu-title">Informes de compras</span>
															<span class="menu-arrow"></span>
														</span>
														<div class="menu-sub menu-sub-accordion menu-active-bg">
															<div class="menu-item">
																<a class="menu-link" href="'.base_url("index.php/iSolicitudes").'">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Informe de solicitudes</span>
																</a>
															</div>
															<div class="menu-item">
																<a class="menu-link" href="'.base_url("index.php/bodega").'">
																	...
																	<span class="menu-title">Informe de Ordenes</span>
																</a>
															</div>
														</div>
													</div>
