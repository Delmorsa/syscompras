				...
				<div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="{default: '#kt_aside_toolbar, #kt_aside_footer', lg: '#kt_header, #kt_aside_toolbar, #kt_aside_footer'}" data-kt-scroll-offset="0">
                            ...
                            <div class="menu-item">
									<a class="menu-link" href="<?php echo base_url("index.php/Areas")?>">
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										<div class="menu-item">
											<a class="menu-link" href="<?php echo base_url("index.php/Usuarios")?>">
                                        ...
                                        <div class="menu-item">
											<a class="menu-link" href="<?php echo base_url("index.php/Roles")?>">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
								...
								<div class="me-5">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-5">
											<a href="../pages/profile/overview.html" class="menu-link px-5">Mi Pefil</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
										<div class="menu-item px-5">
						...
						<div class="toolbar">
							...
							<div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-sm-row align-items-lg-stretch justify-content-sm-between">
								...
								<div class="page-title d-flex flex-column me-5">
									<!--begin::Title-->
									<h1 class="d-flex flex-column text-dark fw-bolder fs-2 mb-0">eCommerce Dashboard</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">Usuarios <!--Modulo--></li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item">
											<span class="bullet bg-gray-300 w-5px h-2px"></span>
								...
								<div class="d-flex align-items-center pt-3 pt-sm-0"> <!-- overflow-auto -->
									...
									<div class="d-flex">
										...
										<!--begin::Chat-->
										<div class="d-flex align-items-center me-4">
											<a href="#" id="kt_drawer_chat_toggle" class="position-relative me-1 btn btn-icon btn-sm btn-active-light btn-outline btn-outline-default btn-icon-gray-700 btn-active-icon-primary" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
												...
												<!--end::Svg Icon-->
												<span class="position-absolute top-100 start-0 translate-middle  badge badge-circle badge-sm badge-primary">
													10
												</span>
											</a>
										</div>
										...
										<div class="d-flex align-items-center">
											...
											<a href="#" class="position-relative me-1 btn btn-icon btn-sm btn-active-light btn-outline btn-outline-default btn-icon-gray-700 btn-active-icon-primary"" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
											   ...
											   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
											    ...
											    <span id="uconectadosBagde" class="position-absolute top-100 start-0 translate-middle badge badge-circle badge-sm badge-primary">
													0
												</span>
											</a>
											<!--begin::Menu-->
