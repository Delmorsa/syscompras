									...
									<div class="card card-flush overflow-hidden h-md-100">
										...
										<div class="card-header py-5">
											...
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark">Solicitudes pendientes de autorizar</span>
							...
							<div class="modal-content">
								...
								<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
									...
									<div class="col-md-3 fv-row">
										...
										<input type="hidden" name="" id="idSolicitudDenegar">
									...
									<div class="form">
										...
										<div class="d-flex flex-column mb-12 fv-row">
										       <table id="tblDetSolicitudes" class="table table-striped table-row-bordered table-responsive gy-5 gs-7">
                                                ...
                                                <table id="tblAutSolicitudes" style="display: none;" class="table table-striped table-row-bordered table-responsive gy-5 gs-7">
                                                    <thead class="">
														<tr class="fw-bold fs-6 text-muted">
															<th>Cantidad <br> Solicitada</th>
															<th>Unidad <br> Medida</th>
										...
										<div class="text-center" id="botones">
											...
											<button type="button" id="btnAutorizarSolic"
												class="btn btn-primary">Autorizar</button>
