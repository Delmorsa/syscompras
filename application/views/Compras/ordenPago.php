									...
									<div class="card card-flush overflow-hidden h-md-100">
										...
										<div class="card-header py-5">
											...
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark">Orden de Pago </span>
												...
												<div class="form" id="campos">
													<div class="row g-12 mb-8">
														<div class="col-md-3 fv-row">
															<label for="listProv" class="form-label">Proveedor</label>
														...
														<div class="col-md-2 fv-row">
															...
															<div class="input-group mb-5">
																...
																<input id="fechaOP" class="form-control valida" value="<?= date("d-m-Y")?>" readonly />
															</div>
															<!--end::Input-->
														</div>
														<div class="col-md-2 fv-row">
															...
															<div class="input-group mb-5">
																...
																<input class="form-control valida" value="" id="cantidad" />
															</div>
															<!--end::Input-->
														</div>
														<div class="col-md-4 fv-row">
															...
															<div class="input-group mb-5">
																...
																<input value="" readonly style="text-transform: capitalize" class="form-control valida" id="cantidadTxt" />
															</div>
															<!--end::Input-->
														</div>
													</div>
													...
													<div class="col-md-4 fv-row">
																...
																<div class="input-group mb-5">
																	...
																	<input value="" class="form-control valida" id="Proveedor" />
																</div>
																<!--end::Input-->
															</div>
														<div class="col-md-6 fv-row">
																...
																<div class="input-group mb-5">
																	...
																	<input value="" class="form-control valida" id="Chequetxt" />
																</div>
																<!--end::Input-->
															</div>
													</div>
													...
													<div class="col-md-2 fv-row">
														<!--begin::Checkbox-->
															<label for="listProv" class="form-label">Aplicar moneda a todos los articulos</label>
															<select id="selectMonedaAll" class="form-select" data-control="select2">
																<option value="C">Manual</option>
																<option value="C">Córdobas</option>
																<option value="S">Dólares</option>
															</select>
														</div>
														...
														<div class="form-check form-check-custom form-check-solid mb-5">
															<!--begin::Input-->
															<input class="form-check-input me-3" name="checkbox_input" type="checkbox" id="chkRetiene" />
															<!--end::Input-->
													...
													<div class="row g-12 mb-8 border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3" style="display: none;" id="divRetiene">
														<div class="col-md-3 fv-row">
