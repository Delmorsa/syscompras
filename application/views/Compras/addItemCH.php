									...
									<div class="card card-flush overflow-hidden h-md-100">
										...
										<div class="card-header py-5">
											...
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark">Agregar items Caja Chica </span>
                                                ...
                                                <div class="d-flex flex-wrap">
                                                    ...
                                                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--end::Svg Icon-->
                                                            <div class="fs-2 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="<?= $encabezado[0]["FechaAutoriza"]?>"><?= $encabezado[0]["FechaSolicitud"]?></div>
                                                        </div>
                                                        <!--end::Number-->
                                                        <!--begin::Label-->
													...
													<div class="row g-12 mb-8">
														...
														<div class="col-md-3 fv-row">
															...
															<div class="input-group flex-nowrap">
																...
																<!--<input id="idSolicitud" type="hidden"
                                                                 ...
                                                                 <input disabled id="listProvtxt" value="<?= $encOrden[0]["Proveedor"]?>" class="form-control valida" />
															</div>
														</div>
														<div class="col-md-2 fv-row">
															...
															<div class="input-group mb-5">
																...
																<input disabled id="fecha" value="<?= $encOrden[0]["fechaRecibo"]?>" data-date-format="yyyy-mm-dd" class="form-control valida" />
															</div>
															<!--end::Input-->
														</div>
														<div class="col-md-2 fv-row">
															...
															<div class="input-group mb-5">
																...
																<input readonly value="<?= $encOrden[0]["Total"]?>" readonly class="form-control valida" id="total" />
                                                                <input class="form-control" type="hidden" value="<?= str_replace(",","",number_format($encOrden[0]["Total"],2))?>" id="cantidadTxt1" />
															</div>
															<!--end::Input-->
														</div>
													</div>
													...
													<div class="row g-12 mb-8">
														<div class="col-md-10 fv-row">
															...
															<div class="input-group">
																...
																<textarea readonly id="concepto"  class="form-control valida" aria-label="With textarea"
													...
													<div class="row g-12 mb-8 border rounded table-responsive">  
														...
														<thead class="">
															...
															<th>
																...
																<input type="text" class="form-control form-control-transparent placeholder" id="sumaTotalFoot" value="<?= number_format($encOrden[0]["Total"],2)?>" placeholder="0">
															</th>
															</tfoot>
														</table>
