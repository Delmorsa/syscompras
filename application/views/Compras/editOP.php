								...
								<div class="row g-12 mb-8">
									...
									<div class="col-md-2 fv-row">
										...
										<div class="input-group mb-5">
											...
											<input id="fechaOP" class="form-control valida" value="<?= date_format(new DateTime($encOrden[0]["FechaAutoriza"]),"Y-m-d")?>" readonly />
										</div>
										<!--end::Input-->
									</div>
									<div class="col-md-2 fv-row">
									...
									<div class="col-md-4 fv-row">
										...
										<div class="input-group mb-5">
											...
											<input value="<?= $encOrden[0]["CantidadDesc"]?>" readonly style="text-transform: capitalize" class="form-control valida" id="cantidadTxt" />
										</div>
										<!--end::Input-->
									</div>
								</div>
