									...
									<div class="card card-flush overflow-hidden h-md-100">
										...
										<div class="card-header py-5">
											...
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark">Orden de Compra </span>
													...
													<div class="row g-12 mb-8">
														...
														<div class="col-md-2 fv-row">
															...
															<div class="input-group mb-5">
                                                                ...
                                                                value="<?= date_format(new DateTime($encOrden[0]["FechaAutoriza"]),"Y-m-d")?>" readonly />
															</div>
															<!--end::Input-->
														</div>
                                                        <div class="col-md-3 fv-row">
															...
															<div class="input-group mb-5">
																...
																<input value="<?= $encOrden[0]["TiempoEntrega"]?>" class="form-control valida" id="TiempoTxt" />
															</div>
															<!--end::Input-->
														</div>
													</div>
													...
													<div class="row g-12 mb-8">
														<div class="col-md-12 fv-row">
															...
															<div class="input-group">
																...
																<textarea id="direccion" class="form-control valida" aria-label="With textarea"
