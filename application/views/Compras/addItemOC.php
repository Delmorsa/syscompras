									...
									<div class="card card-flush overflow-hidden h-md-100">
										...
										<div class="card-header py-5">
											...
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark">Agregar Items a Orden de Compra </span>
											...
											<div class="d-flex flex-wrap">
                                                        ...
                                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <!--end::Svg Icon-->
                                                                <div class="fs-2 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="<?= $encOrden[0]["ConsecutivoOC"]?>" data-kt-countup-prefix="#"><?= $encOrden[0]["ConsecutivoOC"]?></div>
                                                            </div>
                                                            <!--end::Number-->
                                                            <!--begin::Label-->
												...
												<div class="form" id="campos">
													<div class="row g-12 mb-8">
														<div class="col-md-3 fv-row">
															...
															<div class="input-group flex-nowrap">
																...
																<input id="idSolicitud" type="hidden"
																 class="form-control" value="<?= $encOrden[0]["IdSolicitud"]?>" />
                                                                 <input id="idOrden" type="hidden"
																 class="form-control" value="<?= $encOrden[0]["IdOrdenCompra"]?>" />
																<div class="overflow-hidden flex-grow-1">
																	<select id="listProv" disabled
														...
														<div class="col-md-4 fv-row">
															<label for="listProvtxt" class="form-label required">Nombre Proveedor</label>
															<div class="input-group mb-5">
																...
																<input readonly id="listProvtxt" value="<?= $encOrden[0]["Proveedor"]?>" class="form-control valida" />
															</div>
															<!--end::Input-->
														</div>
														<div class="col-md-2 fv-row">
															...
															<div class="input-group mb-5">
																...
																<input id="fechaOC" class="form-control valida" 
                                                                value="<?= date_format(new DateTime($encOrden[0]["FechaCrea"]),"Y-m-d")?>" readonly />
															</div>
															<!--end::Input-->
														</div>
                                                        <div class="col-md-3 fv-row">
															<label for="TiempoTxt" class="form-label required">Tiempo entrega</label>
															<div class="input-group mb-5">
																<span class="input-group-text" id="basic-addon1">
																	<!--begin::Svg Icon | path: icons/duotune/communication/com006.svg-->
																	<span class="svg-icon svg-icon-info svg-icon-3">
																...
																<input readonly value="<?= $encOrden[0]["TiempoEntrega"]?>" class="form-control valida" id="TiempoTxt" />
															</div>
															<!--end::Input-->
														</div>
													</div>
													...
													<div class="row g-12 mb-8">
														<div class="col-md-12 fv-row">
															...
															<div class="input-group">
																...
																<textarea readonly id="direccion" class="form-control valida" aria-label="With textarea"
																	style="height: 97px;"><?= $encOrden[0]["Direccion"]?></textarea>
															</div>
															<!--end::Input group-->
														</div>
													</div>
