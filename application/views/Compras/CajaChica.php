													...
													<div class="row g-12 mb-8">
														...
														<div class="col-md-3 fv-row">
															...
															<div class="input-group flex-nowrap">
																...
																<input id="idSolicitud" type="hidden"
                                                                 ...
                                                                 <input id="listProvtxt" class="form-control valida" />
															</div>
														</div>
														<div class="col-md-2 fv-row">
															...
															<div class="input-group mb-5">
																...
																<input id="fecha" data-date-format="yyyy-mm-dd" class="form-control valida" />
															</div>
															<!--end::Input-->
														</div>
														<div class="col-md-2 fv-row">
															...
															<div class="input-group mb-5">
																...
																<input value="0" readonly class="form-control valida" id="total" />
															</div>
															<!--end::Input-->
														</div>
													</div>
