<script>
    ...
    function autorizar(){
        ...
        "ordering": false,
		"ajax": {
			"url": "<?php echo base_url("index.php/editOrdersC/").$this->uri->segment(2)."/".$this->uri->segment(3)."/".$this->uri->segment(4)?>",
			"type": "POST"
		},
        columns: [
           ...
           let array = new Array(),
				...
				t.rows().eq(0).each(function (index) {
                    ...
                    if(bandera){
                        $("#loading").modal("hide");
                        let form_data = {
                            enc: [$("#idSolicitud").val(),$("#listProv option:selected").val(),$("#listProvtxt").val(),$("#fechaOC").val(),$("#TiempoTxt").val(),$("#direccion").val(),$("#idOrden").val()],
                       ...
                       $.ajax({
                            url: "<?php echo base_url("index.php/updateOrdenCompra")?>",
                            type: "POST",
                            data: form_data,
