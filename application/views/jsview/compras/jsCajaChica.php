    ...
    //$("#loading").modal("show");
        ...
        let array = new Array(),
				...
				t.rows().eq(0).each(function (index) {
                    ...
                    if(bandera){
                        let form_data = {
                            enc: [$("#idSolicitud").val(),$("#listProv option:selected").val(),$("#listProvtxt").val(),$("#fecha").val(),$("#concepto").val(),$("#total").val()],
                      ...
                      $.ajax({
                            url: "<?php echo base_url("index.php/saveCajaChica")?>",
                            type: "POST",
                            data: form_data,
