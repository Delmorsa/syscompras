           ...
           let array = new Array(),
                ...
                t.rows().eq(0).each(function (index) {
                    ...
                    if(bandera){
                        $("#loading").modal("hide");
                        let form_data = {
                            enc: [$("#idSolicitud").val(),$("#listProv option:selected").val(),$("#listProvtxt").val(),$("#fechaOC").val(),$("#TiempoTxt").val(),$("#direccion").val()],
                        ...
                        $.ajax({
                            url: "<?php echo base_url("index.php/saveOrdenCompra") ?>",
                            type: "POST",
                            data: form_data,
