							...
							<div class="modal-content">
								...
								<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
									...
									<div class="form" id="campos">
										...
										<div class="row g-12 mb-8">
											<div class="col-md-6 fv-row">
												<label for="listRoles" class="form-label required">Seleccione un Rol</label>
												...
												<div class="input-group flex-nowrap">
													...
													<div class="overflow-hidden flex-grow-1">
														<select id="listRoles" class="form-select rounded-start-0"
															data-control="select2" data-dropdown-parent="#modalUser"
															data-placeholder="Seleccione un Rol" data-allow-clear="true">
															<option></option>
															<?php
if ($roles) {
...
?>
										...
										<div class="row g-12 mb-8" id="divJefes" style="display: none;">
											<div class="col-md-12 fv-row">
												<label for="listJefes" class="form-label required">Asignar un jefe</label>
												<!--begin::Default example-->
												<div class="input-group flex-nowrap">
													<span class="input-group-text">
														<span class="svg-icon svg-icon-muted svg-icon-2"><svg
													...
													<div class="overflow-hidden flex-grow-1">
														<select id="listJefes" class="form-select rounded-start-0 js-data-example-ajax"
															data-dropdown-parent="#modalUser">
															<option selected value=""></option>
														</select>
													</div>
										...
										<div class="row g-12 mb-8">
											...
											<div class="col-lg-6">
												<label for="" class="form-label required">Seleccione una opcion de autorización</label>
												<!--begin::Tabs-->
												<div class="nav flex-column">
													<!--begin::Tab link-->
													<div id="btnSoli" class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 active mb-6"
														data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_startup">
														<!--end::Description-->
														<div class="d-flex align-items-center me-2">
															<!--begin::Radio-->
