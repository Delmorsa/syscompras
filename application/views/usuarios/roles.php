									...
									<div class="card card-flush overflow-hidden h-md-100">
										...
										<div class="card-header py-5">
											...
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark">Lista de Roles</span>
												<!--<span class="text-gray-400 mt-1 fw-bold fs-6">Users from all channels</span>-->
											</h3>
											<!--end::Title-->
											<!--begin::Toolbar-->
											<div class="card-toolbar">
												<button id="btnAddRol" class="btn btn-primary" data-bs-toggle="modal">
										...
										<div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
											<!--begin::Statistics-->
											<div class="px-9 mb-5">
												<table id="tblRoles" class="table table-striped table-row-bordered table-responsive gy-5 gs-7">
													<thead class="">
                                                            ...
                                                            if($roles){
                                                                foreach ($roles as $key) {
                                                                    ...
                                                                    echo "
                                                                        <tr>
                                                                            <td>".$key["NombreRol"]."</td>
                                                                            <td>".$key["FechaGuarda"]."</td>
                                                                            <td>".$estado."</td>";
                                                                            if($key["Estado"] == "A"){
                                                                                echo "
                                                                                <td class='text-center'>
                                                                                    <a href='javascript:void(0)' onclick='editar(".'"'.$key["IdRol"].'","'.$key["NombreRol"].'"'.")' id='btnEditRol' class='btn btn-icon btn-primary btn-sm btn-hover-rise me-5'>
                                                                                    ...
                                                                                    <a href='javascript:void()' onclick='baja(".'"'.$key["IdRol"].'","'.$key["Estado"].'"'.")'
																					 id='btnDeleteRol' class='btn btn-icon btn-danger btn-sm btn-hover-rise me-5'>
                                                                                        <span class='svg-icon svg-icon-3'>
                                                                                            <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none'>
									...
									<div class="form">
										...
										<div class="d-flex flex-column mb-7 fv-row">
											...
											<div class="input-group mb-5">
												...
												<input type="text" id="nombreRol" class="form-control" placeholder="Ingresa el nombre del rol" aria-label="Nombre"
